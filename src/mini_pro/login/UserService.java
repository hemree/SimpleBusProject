...
public class UserService {
    ...
    public void login (){
        Scanner scanner = new Scanner(System.in);
        System.out.println("kullanıcı adı veya email gırınız");
        String usernameOremail = scanner.nextLine();

       boolean Mail =  emailList.contains(usernameOremail);
       boolean username=  usernameList.contains(usernameOremail);
       ...
       if (Mail||username){
           ...
           if (passwordList.get(idx).equals(psw)){
               ...
               System.out.println("sifreniz yanlıs tekrar deneyin");
           }
           }
       }
